...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::export_runtime_yaml_webdav,
            cmd::import_runtime_yaml_from_webdav,
            ...
            cmd::reorder_profile,
            cmd::update_profile,
            cmd::get_profile_activation,
            cmd::get_network_diagnostics,
            cmd::retry_profile_activation,
            cmd::delete_profile,
            ...
            cmd::upload_ui_wallpapers_webdav,
            cmd::download_ui_wallpapers_webdav,
